...
/// @brief  Core IR types: PrimitiveKind, FieldDesc, TypeId, TypeDescriptor.
...
/// Runtime description of a type produced by all three registration paths.
...
/// Forward declaration used by the IRIS_TYPE macro in sdk.hpp.
